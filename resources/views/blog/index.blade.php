	...
	<section class="bg-dark text-light footer-long">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col">
					<div class="media">
						<img alt="Image" src="{{ getBlogAvatar($blog->name) }}" class="mr-md-5 avatar avatar-xlg shadow case-study">
						<div class="media-body">
							<div class="mb-3">
								<h1 class="h2 mb-2">{{ $blog->title }}</h1>
		...
		<div class="row mb-4">
			<div class="col-12 d-flex justify-content-between">
				<div class="d-flex align-items-center">
					...
					<a href="{{ request()->fullUrlWithQuery(['type' => 'video'])}}" class="btn btn-secondary mb-1">Videos</a>
				</div>
			</div>
		</div>
